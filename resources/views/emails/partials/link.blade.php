<tr>
    <td style="font-family: 'Montserrat';">
        Please click the link below to view the detail
    </td>
</tr>
<tr>
    ...
    <td>
        <table style="background:#f2f4fb;border-radius: 20px;">
            ...
            <tr>
                ...
                <td>
                    <a style="color: #2c86ee;text-decoration:none;font-family: 'Montserrat';" href="{{config('app.url')}}/{{$path}}">
                        <strong style="font-weight:normal;word-break:break-all;">{{config('app.url')}}/{{$path}}</strong>
                    </a>
                </td>
                <td width="6" style="width:6px;"></td>
            </tr>
