...
class QuizBasicTest extends TestCase
{
    ...
    {
        $response = $this->json('POST', '/api/iu/courses/'.$this->data->course->id.'/lessons/'.$this->data->lesson->id.'/video', ['timestamp' => 100, 'updateLessonProgress' => true]);
    ...
    {
        $response = $this->json('POST', '/api/iu/courses/'.$this->data->course->id.'/lessons/'.$this->data->lesson2->id.'/video', ['timestamp' => 100, 'updateLessonProgress' => true]);
    ...
    public function testModuleQuizSubmittedInValid()
    {
        ...
        $response = $this->json('POST', '/api/iu/courses/'.$this->data->course->id.'/course-modules/'.$this->data->courseModule->id.'/quiz', ['answers' => json_decode($this->QuizAnswersGenerator(1, 1, 1, 1)->answers)]);
    ...
    public function testLevelQuizSubmittedInValid()
    {
        ...
        $response = $this->json('POST', '/api/iu/courses/'.$this->data->course->id.'/course-levels/'.$this->data->courseLevel->id.'/quiz', ['answers' => json_decode($this->QuizAnswersGenerator(1, 1, 1, 1)->answers)]);
