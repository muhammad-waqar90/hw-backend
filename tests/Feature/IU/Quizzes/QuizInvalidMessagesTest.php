...
class QuizInvalidMessagesTest extends TestCase
{
    ...
    public function testLessonAnswerInvalid()
    {
        ...
        $this->json('POST',  '/api/iu/courses/' . $this->data->course->id . '/lessons/' . $this->data->lesson->id . '/quiz', array('answers' => json_decode($this->QuizQuestionGenerator(null, 4, null, null, true)->answers)));
