...
class LessonsTest extends TestCase
{
    ...
    public function testEbooksGetRoute() {
        $response = $this->json('GET', '/api/af/courses/' . $this->data->course->id . '/levels/' . $this->data->courseLevel->id . '/modules/' . $this->data->courseModule->id . '/lessons/' . $this->data->lesson->id . '/ebook');
