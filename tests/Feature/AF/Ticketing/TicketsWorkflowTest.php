...
class TicketsWorkflowTest extends TestCase
{
    ...
    private $admin, $user, $otherAdmin, $tickets, $course;
    ...
    {
        $response = $this->json('PUT',  'api/af/tickets/' . $this->tickets[0]->id . '/categories', array('categoryId' => 2));
    ...
    {
        $response = $this->json('PUT',  'api/af/tickets/' . $this->tickets[0]->id . '/categories', array('categoryId' => 1));
    ...
    {
        $response = $this->json('PUT',  'api/af/tickets/' . $this->tickets[0]->id . '/categories', array('categoryId' => 999));
    ...
    public function testCheckMessagesAsUserForUnclaimedTicketValid()
    {
        ...
        $response = $this->actingAs($this->user)->json('POST',  'api/iu/tickets/' . $this->tickets[0]->id . '/messages', array(
            'message' => $message,
            'assets' => []
        ));
    ...
    public function testCheckMessagesAsUserForReopenedTicketValid()
    {
        ...
        $response = $this->actingAs($this->user)->json('POST',  'api/iu/tickets/' . $ticket->id . '/messages', array(
            'message' => $message,
            'assets' => []
        ));
    ...
    public function testCheckMessagesAsAdminForClaimedTicketValid()
    {
        ...
        $response = $this->json('POST',  'api/af/tickets/' . $ticket->id . '/messages', array(
            'message' => $message,
            'assets' => []
        ));
